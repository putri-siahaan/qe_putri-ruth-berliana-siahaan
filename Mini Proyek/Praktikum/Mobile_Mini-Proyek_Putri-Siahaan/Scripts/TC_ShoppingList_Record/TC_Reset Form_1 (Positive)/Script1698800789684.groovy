...
Mobile.tap(findTestObject('Object Repository/Reset/resetButton'), 0)

Mobile.waitForElementPresent(findTestObject('Object Repository/Reset/formAddNewItem'), 45)

Mobile.getText(findTestObject('Object Repository/Reset/formAddNewItem'), 0)
